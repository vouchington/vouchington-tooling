  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'packages/*/src/contract-schema/index.mts',
        'packages/*/src/contract-schema/types.mts',
        'packages/*/src/contract-schema/typescript-api.mts',
        'packages/*/src/api-fixtures/index.mts',
